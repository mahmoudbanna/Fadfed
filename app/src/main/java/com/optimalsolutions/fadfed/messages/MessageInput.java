...
public class MessageInput extends RelativeLayout implements View.OnClickListener, TextWatcher, KeyPadListener {

    protected EmojiconEditText messageInput;
    protected ImageButton messageSendButton, emjoyButton, attachmentButton;
    protected Space sendButtonSpace, attachmentButtonSpace, emjoyButtonSpace;
    ...
    public void setText(CharSequence input){
        ...
        getInputEditText().setText(input);
    }
    @Override
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.emjoyButton.setImageDrawable(style.geEmjoyButtonIcon());
        this.emjoyButton.getLayoutParams().width = style.getEmjoyButtonWidth();
        this.emjoyButton.getLayoutParams().height = style.getEmjoyButtonHeight();
        ViewCompat.setBackground(emjoyButton, style.getEmjoyButtonBackground());

        this.sendButtonSpace.getLayoutParams().width = style.getInputButtonMargin();
        this.emjoyButtonSpace.getLayoutParams().width = style.getEmjoyButtonMargin();
    ...
    private void init(Context context) {
        ...
        emjoyButton = (ImageButton) findViewById(R.id.emjoyButton);
        attachmentButton = (ImageButton) findViewById(R.id.attachmentButton);
        sendButtonSpace = (Space) findViewById(R.id.sendButtonSpace);
        emjoyButtonSpace = (Space) findViewById(R.id.emjoyButtonSpace);
        attachmentButtonSpace = (Space) findViewById(R.id.attachmentButtonSpace);

        EmojiconsPopup popup = new EmojiconsPopup(this, context, emjoyButton, messageInput);
    ...
    @Override
    public void onClose() {
        emjoyButton.setVisibility(View.VISIBLE);
    }
