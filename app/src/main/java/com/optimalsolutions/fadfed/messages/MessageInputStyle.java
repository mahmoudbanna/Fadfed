...
package com.optimalsolutions.fadfed.messages;
...
import com.optimalsolutions.fadfed.chatkit.commons.Style;
...
class MessageInputStyle extends Style {
    ...
    private int emjoyButtonBackground;
    private int emjoyButtonDefaultBgColor;
    private int emjoyButtonDefaultBgPressedColor;
    private int emjoyButtonDefaultBgDisabledColor;

    private int emjoyButtonIcon;
    private int emjoyButtonDefaultIconColor;
    private int emjoyButtonDefaultIconPressedColor;
    private int emjoyButtonDefaultIconDisabledColor;

    private int emjoyButtonWidth;
    private int emjoyButtonHeight;
    private int emjoyButtonMargin;
    ...
    static MessageInputStyle parse(Context context, AttributeSet attrs) {
        ...
        style.emjoyButtonBackground = typedArray.getResourceId(R.styleable.MessageInput_emjoyButtonBackground, -1);
        style.emjoyButtonDefaultBgColor = typedArray.getColor(R.styleable.MessageInput_emjoyButtonDefaultBgColor, style.getColor(R.color.cornflower_blue_two));
        style.emjoyButtonDefaultBgPressedColor = typedArray.getColor(R.styleable.MessageInput_emjoyButtonDefaultBgPressedColor,style.getColor(R.color.cornflower_blue_two_dark));
        style.emjoyButtonDefaultBgDisabledColor = typedArray.getColor(R.styleable.MessageInput_emjoyButtonDefaultBgDisabledColor, style.getColor(R.color.white_four));

        style.emjoyButtonIcon = typedArray.getResourceId(R.styleable.MessageInput_emjoyButtonIcon, -1);
        style.emjoyButtonDefaultIconColor = typedArray.getColor(R.styleable.MessageInput_emjoyButtonDefaultIconColor,style.getColor(R.color.white));
        style.emjoyButtonDefaultIconPressedColor = typedArray.getColor(R.styleable.MessageInput_emjoyButtonDefaultIconPressedColor, style.getColor(R.color.white));
        style.emjoyButtonDefaultIconDisabledColor = typedArray.getColor(R.styleable.MessageInput_emjoyButtonDefaultIconDisabledColor,style.getColor(R.color.warm_grey));

        style.emjoyButtonWidth = typedArray.getDimensionPixelSize(R.styleable.MessageInput_emjoyButtonWidth, style.getDimension(R.dimen.input_button_width));
        style.emjoyButtonHeight = typedArray.getDimensionPixelSize(R.styleable.MessageInput_emjoyButtonHeight, style.getDimension(R.dimen.input_button_height));
        style.emjoyButtonMargin = typedArray.getDimensionPixelSize(R.styleable.MessageInput_emjoyButtonMargin, style.getDimension(R.dimen.input_button_margin));
    ...
    protected Drawable geEmjoyButtonIcon() {
        if (emjoyButtonIcon == -1) {
            return getSelector(emjoyButtonDefaultIconColor, emjoyButtonDefaultIconPressedColor,
                    emjoyButtonDefaultIconDisabledColor, R.drawable.smiley);
        } else {
            return getDrawable(inputButtonIcon);
        }
    }
    protected Drawable getEmjoyButtonBackground() {
        if (emjoyButtonBackground == -1) {
            return getSelector(emjoyButtonDefaultBgColor, emjoyButtonDefaultBgPressedColor,
                    emjoyButtonDefaultBgDisabledColor, R.drawable.mask);
        } else {
            return getDrawable(emjoyButtonBackground);
        }
    }
    ...
    protected int getEmjoyButtonWidth() {
        return emjoyButtonWidth;
    }

    protected int getEmjoyButtonHeight() {
        return emjoyButtonHeight;
    }

    protected int getEmjoyButtonMargin() {
        return emjoyButtonMargin;
    }
