...
public class EmojiconsPopup extends PopupWindow implements ViewPager.OnPageChangeListener, EmojiconRecents {
     ...
     */
    public EmojiconsPopup(View rootView, final Context mContext, final ImageView emojiButton, final EmojiconEditText emojiconEditText) {
